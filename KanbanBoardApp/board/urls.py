...
urlpatterns = [
    ...
    path('api/workspace-<int:pk>/get-particular-boards/', views.get_particular_boards_view, name='get-boards-by-workspace'),
    ...
    path('api/get-all-other-workspaces/', views.get_all_other_workspace_view, name='get-all-other-workspaces'),
]   
